            ...
            <tr>
                <th colspan="16" class="header-add">
                    <div class="containerForBtn">
                        <button class="btnAdd"  onclick="replaceInsertTable();"><i class="fa-solid fa-plus"></i>Add</button>
            ...
            if(mysqli_num_rows($query_run)>0)
            {
                while($row=mysqli_fetch_assoc(($query_run)))
                {
                    ...
                    <tr>
                        ...
                        <td><button type="button" name="deleteBtn" class="button deleteBtn">Delete</button></td>
                        <td><button type="button" name="editBtn" class="button editBtn">Edit</button></td>
