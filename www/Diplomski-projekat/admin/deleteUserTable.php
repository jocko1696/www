...
<head>
    <meta charset="UTF-8">
    <title>Delete user | Sarah</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Kaushan+Script&display=swap" rel="stylesheet">
    <link rel="stylesheet" href=../css/deleteUserTable.css>
...
<div class="background">
    ...
    <div id="deleteTable" class="deleteTable">
        <form class="form" method="post" action="../back-end/delete-user.php" >
            <h2>Delete existing user</h2>
            <p>Do you want to delete existing user Sarah's store database ?</p>
